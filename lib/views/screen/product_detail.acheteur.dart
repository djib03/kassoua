...
class _ProductDetailAcheteurState extends State<ProductDetailAcheteur>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              if (produit.estnegociable == true)
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Iconsax.tag, size: 14, color: Colors.orange),
                      SizedBox(width: 4),
                      Text(
                        'Négociable',
                        style: TextStyle(
          ...
          // Informations sur la livraison et négociation
          _buildPurchaseOptionsSection(produit, isDark),
  ...
  Widget _buildPurchaseOptionsSection(Produit produit, bool isDark) {
    return Container(
      padding: EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: isDark ? AppColors.dark : Colors.white,
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: (produit.estnegociable == true
                          ? Colors.orange
                          : Colors.grey)
                      .withOpacity(0.1),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      produit.estnegociable == true
                          ? 'Le vendeur accepte les négociations'
            ...
            children: [
              Container(
                ...
                child: Icon(
                  Iconsax.truck,
                  size: 16,
                  color: produit.isLivrable == true ? Colors.blue : Colors.grey,
                ),
              ),
              SizedBox(width: 12),
              Expanded(
